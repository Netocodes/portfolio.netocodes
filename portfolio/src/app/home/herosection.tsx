          ...
          <div className=" flex flex-col items-center justify-center gap-y-8  lg:gap-y-5">
            ...
            <div className="flex gap-x-4">
              <a href="/projects">
                ...
                >
                  <Button
                    className="bg-[#1013d7] text-white cursor-pointer dark:text-black dark:bg-cyan-300"
                    size="lg"
                  >
                    View Projects
                  </Button>
              ...
              <a href="#ContactMe">
                ...
                >
                  <Button
                    className="bg-[#1013d7] text-white cursor-pointer dark:text-black dark:bg-cyan-300 -z-20"
                    size="lg"
                  >
                    Contact Me
                  </Button>
